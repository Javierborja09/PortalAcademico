...
import HorarioItem from "@/components/horario/HorarioItem";
import HorarioAdmin from "@/components/horario/HorarioAdmin";
      ...
      <header className="flex flex-col xl:flex-row xl:items-center justify-between gap-6 mb-10">
        <div>
          ...
          <p className="text-slate-500 font-medium text-sm">
            Gestión de horarios y aulas por curso
          </p>
        </div>
        ...
        <table className="w-full text-left border-collapse">
          <thead className="hidden lg:table-header-group">
            <tr className="bg-slate-50/50 border-b border-slate-100">
              <th className="p-6 text-slate-400 font-black text-[10px] uppercase tracking-[0.2em]">
                Curso
              </th>
              <th className="p-6 text-slate-400 font-black text-[10px] uppercase tracking-[0.2em]">
                Día y Horario
              ...
              <th className="p-6 text-slate-400 font-black text-[10px] uppercase tracking-[0.2em] text-right">
                Acciones
              </th>
            </tr>
          </thead>
          <tbody className="flex flex-col lg:table-row-group gap-4 lg:gap-0">
            {loading ? (
              ...
              <tr>
                <td
                  colSpan="4"
                  className="bg-white p-20 rounded-[2.5rem] text-center text-slate-400 font-bold border-2 border-dashed border-slate-100"
                >
