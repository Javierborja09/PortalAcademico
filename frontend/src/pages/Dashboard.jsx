    ...
    <div className="animate-fadeIn">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-slate-500 font-medium mt-1">
                Bienvenido, {nombre}. Gestiona tus actividades académicas de
                hoy.
              </p>
            </div>
          </div>
      ...
      <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
        ...
        <div className="bg-white p-8 rounded-[2.5rem] border border-slate-100 shadow-sm">
          ...
          <p className="text-slate-500 text-sm leading-relaxed">
            Próximamente podrás visualizar tus estadísticas y accesos rápidos
            aquí.
          </p>
        </div>
      ...
      <div className="mt-8 p-12 bg-slate-50 border-2 border-dashed border-slate-200 rounded-[3rem] flex flex-col items-center justify-center text-center">
        ...
        <p className="text-slate-400 text-sm max-w-xs mt-2">
          Puedes usar este espacio para mostrar calendarios, anuncios globales o
          el horario del día.
        </p>
      </div>
    </div>
