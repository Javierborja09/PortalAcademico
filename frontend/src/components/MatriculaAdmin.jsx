            ...
            <div className="bg-white w-full max-w-2xl rounded-[2.5rem] shadow-2xl overflow-hidden animate-slideUp border border-white/10">
                ...
                <header className="bg-slate-900 p-6 text-white flex justify-between items-center">
                    <div className="flex items-center gap-3">
                        ...
                        <div>
                            <h2 className="font-black text-lg uppercase tracking-tight">Gestión de Matrículas</h2>
                ...
                <div className="p-8">
                                        ...
                                        <div key={u.id_usuario} className="flex items-center justify-between p-3 hover:bg-indigo-50/50 rounded-xl transition-colors">
                                            <div className="flex items-center gap-3 text-left">
                                                ...
                                                <div className="flex flex-col">
                                                    ...
                                                    <span className="text-[10px] text-indigo-500 font-semibold">{u.correo}</span>
                                                </div>
                                            </div>
                                            <button 
                    ...
                    <h3 className="text-[10px] font-black uppercase text-slate-400 tracking-[0.2em] mb-4 ml-2">Integrantes del curso</h3>
                    <div className="space-y-3 max-h-80 overflow-y-auto pr-2 custom-scrollbar">
                        {loading ? (
                            <div className="flex flex-col items-center justify-center py-10 gap-2">
                                <Loader2 className="animate-spin text-indigo-600" />
                                <span className="text-[10px] font-bold text-slate-400 uppercase">Cargando lista...</span>
                            </div>
                            ...
                            <div className="text-center py-16 bg-slate-50/30 rounded-3xl border border-dashed border-slate-200">
                                ...
                                <p className="font-bold text-[10px] uppercase tracking-widest text-slate-300">No hay alumnos matriculados</p>
                            </div>
                        )}
                    </div>
                </div>
