        ...
        <div className="flex flex-col h-full bg-white rounded-[2rem] border border-slate-100 shadow-xl overflow-hidden">
            ...
            <div className="flex-1 overflow-y-auto p-4 space-y-3 bg-slate-50/50">
                ...
                {messages.map((msg, index) => (
                    <div key={index} className={`flex ${msg.remitente === usuarioNombre ? "justify-end" : "justify-start"}`}>
                        <div className={`max-w-[85%] p-3 rounded-2xl shadow-sm ${
                            ...
                            {msg.remitente !== usuarioNombre && (
                                <p className="text-[9px] font-black uppercase text-indigo-500 mb-1 truncate">{msg.remitente}</p>
                            )}
