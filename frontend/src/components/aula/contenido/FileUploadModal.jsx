...
const FileUploadModal = ({ isOpen, fileData, setFileData, loading, onClose, onSubmit }) => {
    ...
    return (
        <div className="fixed inset-0 z-[160] flex items-center justify-center p-4">
            ...
            <form onSubmit={onSubmit} className="relative bg-white w-full max-w-lg rounded-[3rem] shadow-2xl overflow-hidden animate-slideUp">
                ...
                <div className="p-10 space-y-6">
                    <div className="space-y-2">
                        ...
                        <input 
                            ...
                            onChange={(e) => setFileData({...fileData, titulo: e.target.value})}
