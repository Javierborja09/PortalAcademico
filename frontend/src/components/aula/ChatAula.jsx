...
const ChatAula = ({ cursoId, usuarioNombre }) => {
  const { messages, input, setInput, isConnected, scrollRef, sendMessage } =
        ...
        {messages.map((msg, index) => {
          ...
          return (
            ...
            >
              ...
              <div
                className={`flex flex-col ${esMio ? "items-end" : "items-start"} max-w-[75%]`}
              >
                <div className="flex items-center gap-2 mb-1.5 px-1">
                  ...
                  <span
                    className={`text-[7px] font-black uppercase px-1.5 py-0.5 rounded-md border ${
                      esDocente
