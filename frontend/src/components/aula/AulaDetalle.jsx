...
const AulaDetalle = ({ isOpen, onClose, curso }) => {
  ...
  return (
    ...
    >
      <div
        className="bg-white w-full max-w-lg rounded-[3rem] p-12 shadow-2xl animate-slideUp"
        ...
        <div className="space-y-6">
          <div className="p-6 bg-slate-50 rounded-3xl border border-slate-100">
            ...
            <p className="text-slate-600 font-medium">
              Entorno virtual de {curso?.nombreCurso}.
            </p>
          </div>
        </div>
        <button
          onClick={onClose}
          className="mt-10 w-full py-5 bg-slate-900 text-white rounded-2xl font-black uppercase text-xs tracking-widest hover:bg-blue-600 transition-all shadow-xl"
        >
          Entendido
        </button>
      </div>
