    ...
    <div className="fixed inset-0 z-[110] flex items-center justify-center p-4">
      ...
      <form onSubmit={handleSubmit} className="relative bg-white w-full max-w-2xl rounded-[3rem] shadow-2xl overflow-hidden animate-slideUp">
        ...
        <div className="p-10 grid grid-cols-1 md:grid-cols-2 gap-6">
          {/* Portada del Curso usando el componente Avatar */}
            ...
            <div className="w-full h-40 rounded-[2rem] bg-slate-50 border-2 border-dashed border-slate-200 overflow-hidden relative group">
              {preview ? (
                <Avatar 
                  src={preview} 
                  type="curso" 
                  className="w-full h-full border-none shadow-none group-hover:scale-105" 
                  alt="Vista previa" 
                />
              ) : (
          ...
          <div className="space-y-2">
            ...
            <div className="relative">
              ...
              <input 
                name="nombreCurso" 
                required 
                className="w-full pl-12 pr-4 py-4 bg-slate-50 border-transparent rounded-2xl focus:bg-white focus:ring-2 focus:ring-blue-500/20 transition-all font-bold text-slate-700 outline-none"
          ...
          <div className="md:col-span-2 space-y-2">
            ...
            <div className="relative">
              ...
              <select 
                name="idDocente" 
                required 
                className="w-full pl-12 pr-4 py-4 bg-slate-50 border-transparent rounded-2xl focus:bg-white font-bold text-slate-700 appearance-none outline-none"
          ...
          <div className="space-y-2">
            ...
            <input 
              ...
              type="date" 
              required 
              className="w-full px-6 py-4 bg-slate-50 border-transparent rounded-2xl font-bold text-slate-700 outline-none"
